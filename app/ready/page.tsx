  ...
  return (
    <main className="min-h-screen bg-[#0a0a08] flex items-center justify-center px-6">
      <div className={`max-w-xl text-center transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        <h1 className="text-3xl md:text-5xl font-light text-[#F5E6C8] font-display leading-tight mb-4">
          {readyPageText.title}
        </h1>

        <p className="text-[#8A7D65] leading-relaxed mb-10 text-base">
        ...
        <div className="mb-10">
          <p className="text-sm tracking-[0.2em] uppercase text-[#C5A55A] mb-6">
          ...
          <div className="space-y-6">
            {readyPageText.questions.map((q, i) => (
              <p
                key={i}
                className={`text-lg md:text-xl text-[#F5E6C8]/80 italic font-display leading-relaxed transition-all duration-1000 ${
        ...
        <p className="text-sm text-[#8A7D65] italic mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="group px-8 py-4 border border-[#D4AF37]/30 text-[#C5A55A] tracking-[0.15em] uppercase text-sm transition-all duration-500 hover:border-[#D4AF37]/60 hover:text-[#F5E6C8]"
          >
            <span className="block">{readyPageText.secondaryButton}</span>
            <span className="block text-[10px] text-[#8A7D65] mt-1 tracking-normal normal-case group-hover:text-[#C5A55A] transition-colors">
