      ...
      <div className="bg-card border border-gold/30 p-6 max-w-md w-full mx-4 shadow-2xl">
        ...
        <div className="flex gap-3 justify-end mt-6">
          <button
            onClick={onCancel}
            disabled={loading}
            className="px-5 py-2 border border-gold/20 text-muted-foreground text-sm uppercase hover:bg-gold/5 transition-colors disabled:opacity-40"
          >
            Hủy
          </button>
          <button
  ...
  return (
    <div className="flex items-center gap-1 border border-gold/20 bg-card px-2 py-1">
      ...
      <button
        onClick={() => shiftDay(1)}
        disabled={isToday}
        className="p-1.5 text-muted-foreground hover:text-gold transition-colors disabled:opacity-20 disabled:cursor-not-allowed"
        title="Ngày sau"
      >
      ...
      {!isToday && (
        <button
          ...
          className="text-[10px] px-2 py-1 text-gold border border-gold/20 hover:bg-gold/10 transition-colors uppercase"
        >
          Hôm nay
        </button>
      )}
        ...
        <div className="flex flex-col gap-1.5 flex-1 min-w-0">
          <div className="flex gap-1">
            ...
            <button
              ...
              className="px-2 border border-gold/20 text-gold hover:bg-gold/10 transition-colors"
              title="Áp dụng URL"
            >
          ...
          <button
            ...
            onClick={() => fileRef.current?.click()}
            disabled={uploading}
            className="flex items-center gap-1.5 px-2.5 py-1.5 border border-gold/20 text-gold text-[10px] uppercase hover:bg-gold/10 transition-colors disabled:opacity-40 w-fit"
          >
            {uploading ? (
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          onClick={() => fileRef.current?.click()}
          disabled={uploading}
          className="flex items-center gap-1 px-3 py-2 border border-gold/20 text-gold text-xs uppercase hover:bg-gold/10 disabled:opacity-40"
        >
  ...
  return (
    <main className="min-h-screen bg-background p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        {product.product_type === "ritual" ? (
                          <span className="text-[9px] px-2 py-0.5 border border-gold text-gold uppercase">
                            Ritual
                          </span>
                        ) : (
                          <span className="text-[9px] px-2 py-0.5 border border-[#8A7D65] text-muted-foreground uppercase">
                            Gift
                          </span>
                        )}
                      </td>
        ...
        {tab === "banners" && (
          <>
            <div className="mb-6 p-5 border border-gold/20 bg-card">
              <h3 className="text-sm uppercase tracking-widest text-gold mb-4">
                Thêm Banner mới
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] text-muted-foreground uppercase">Tiêu đề (tùy chọn)</label>
                  <input
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] text-muted-foreground uppercase">Link khi nhấn (tùy chọn)</label>
                  <input
            ...
            <div className="border border-gold/20 bg-card">
        ...
        {tab === "orders" && (
          <>
            ...
            <div className="flex flex-col md:flex-row gap-3 mb-6">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-gold/20 bg-card text-foreground text-sm outline-none focus:border-gold/50 placeholder-[#8A7D65]/60"
                />
                {searchPhone && (
                  <button
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full md:w-auto pl-10 pr-8 py-2.5 border border-gold/20 bg-card text-foreground text-sm outline-none focus:border-gold/50 cursor-pointer appearance-none"
                >
            ...
            <div className="flex items-center justify-between mb-4 text-sm">
              ...
              {(searchPhone || filterType !== "all" || filterStatus !== "all") && (
                <button
                  ...
                  className="text-gold hover:underline text-xs uppercase"
                >
                  Xóa bộ lọc
                </button>
              )}
            ...
            {editingOrder && (
              <div className="mb-6 p-6 border border-gold/20 bg-card">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
                    <label className="text-[10px] text-muted-foreground uppercase">Người gửi</label>
                    <input
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-[10px] text-muted-foreground uppercase">Người nhận</label>
                    <input
                  ...
                  <div className="flex flex-col gap-1 md:col-span-2">
                    <label className="text-[10px] text-muted-foreground uppercase">Lời nhắn</label>
                    <textarea
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  {filteredOrders.map((order) => {
                    ...
                    return (
                      <tr key={order.id} className="border-b border-gold/10 hover:bg-[var(--secondary)]/50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          ...
                          {isExpanded && (
                            <div className="mt-2 space-y-1 text-[11px] text-muted-foreground border-t border-gold/10 pt-2">
                              ...
                              {order.message && (
                                <div className="mt-1 text-gold/70 italic">
                                  &ldquo;{order.message}&rdquo;
                                </div>
                              )}
                              {order.blockchain_hash && (
                                <div className="mt-1 text-[10px] font-mono text-gold/50 truncate max-w-[200px]">
                        ...
                        <td className="px-4 py-3">
                          {order.product ? (
                            <div>
                              <div className="text-foreground text-xs">{order.product.name}</div>
                              <div className="text-[10px] text-muted-foreground">SL: {qty}</div>
                            </div>
                          ) : (
                        ...
                        <td className="px-4 py-3">
                          {order.product?.product_type === "ritual" ? (
                            <span className="text-[9px] px-2 py-0.5 border border-gold/40 text-gold uppercase">
                              Ritual
                            </span>
                          ) : order.product?.product_type === "gift" || order.ritual_type === "Gift" ? (
                            <span className="text-[9px] px-2 py-0.5 border border-[#8A7D65]/40 text-muted-foreground uppercase">
                              Gift
                            </span>
                          ) : order.ritual_type ? (
                            <span className="text-[9px] px-2 py-0.5 border border-gold/40 text-gold uppercase">
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={`px-2 py-0.5 text-[10px] uppercase border ${STATUS_COLORS[order.status] || "text-muted-foreground"}`}
                          >
                        ...
                        <td className="px-4 py-3">
                          <div className="flex gap-1 items-center flex-wrap">
                            <button
                              ...
                              title="Xem chi tiết"
                              className="p-1.5 text-muted-foreground hover:text-foreground hover:bg-gold/10 transition-colors"
                            >
                              {isExpanded ? (
                            ...
                            {canEditOrder(order) && (
                              <button
                                ...
                                title="Sửa"
                                className="p-1.5 text-gold hover:bg-gold/10 transition-colors"
                              >
                                <Edit2 className="h-4 w-4" />
                              </button>
                            )}
      ...
      {showProductForm && (
        ...
        >
          <div className="bg-card border border-gold/30 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="sticky top-0 bg-card border-b border-gold/20 px-6 py-4 flex justify-between items-center z-10">
              <h3 className="text-sm uppercase tracking-widest text-gold">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] text-muted-foreground uppercase">Tên sản phẩm *</label>
                  <input
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] text-muted-foreground uppercase">Loại bộ sưu tập</label>
                  <select
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] text-muted-foreground uppercase">Giá (VND) *</label>
                  <input
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] text-muted-foreground uppercase">Danh mục</label>
                  <input
                ...
                <div className="md:col-span-2 flex flex-col gap-1">
                  <label className="text-[10px] text-muted-foreground uppercase">Mô tả sản phẩm</label>
                  <textarea
                ...
                <div className="md:col-span-2">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <span className="text-muted-foreground text-sm">Cho phép đặt vĩnh cửu</span>
                  </label>
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-6 pt-4 border-t border-gold/10">
                <button
                  ...
                  className="px-5 py-2.5 border border-gold/20 text-muted-foreground text-sm uppercase hover:bg-gold/5 transition-colors"
                >
                  Hủy
                </button>
                <button
      ...
      >
        <div className="bg-gold/5 border border-gold/20 p-3 mb-2">
          <p className="text-[11px] text-gold leading-relaxed">
            <strong className="text-gold">Đơn hàng:</strong> {mintConfirmModal.orderLabel}
          </p>
