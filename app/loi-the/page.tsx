        ...
        <div className="mx-auto max-w-lg">
          <div className="relative">
            <div
              ...
              style={{ background: 'linear-gradient(180deg, transparent, var(--gold) 10%, var(--gold) 90%, transparent)' }}
            />
              ...
              {vows.map((vow, i) => (
                <FadeInSection key={`${vow.city}-${i}`} delay={i * 120}>
                  <div className="relative flex items-start gap-6 py-6">
                    ...
                    <span className="hidden md:block pt-3 text-sm italic text-muted-foreground">
          ...
          <FadeInSection delay={1000}>
            <div className="mt-14 text-center">
              ...
              <p className="mt-4 text-base italic font-display text-gold">
